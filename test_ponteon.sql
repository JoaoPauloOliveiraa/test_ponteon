...
--
-- Host: localhost:3306
-- Tempo de geração: 05/04/2021 às 23:29
...
--
-- Estrutura para tabela `empresarios`
--
...
CREATE TABLE `empresarios` (
  ...
  `business_parent` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `empresarios`
--

INSERT INTO `empresarios` (`id`, `name`, `cell`, `city`, `business_parent`, `created_at`, `updated_at`) VALUES
(5, 'Joao', '12334567344', 'Agua Branca/PB', 'CEEPA Fernando Costa', '2021-04-06 01:47:55', '2021-04-06 01:47:55'),
(6, 'Jose', '09837465781', 'Abadia/BA', 'Joao', '2021-04-06 01:50:40', '2021-04-06 01:50:40');
...
(1, '2021_04_02_142745_create_empresarios_table', 1),
(2, '2021_04_04_224809_create_cidades_table', 1),
(3, '2021_04_04_224809_create_estados_table', 1),
(4, '2021_04_04_224810_add_foreign_keys_to_cidades_table', 1);
...
--
ALTER TABLE `cidades`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9390;
...
--
ALTER TABLE `cidades`
  ADD CONSTRAINT `fk_cidades_estados1` FOREIGN KEY (`estados_id`) REFERENCES `estados` (`id`);
COMMIT;
